#include "GA_MutantCutterSkill.h"
#include "AbilitySystemComponent.h"
#include "MutateArena/Characters/Mutants/MutantCutter.h"

UGA_MutantCutterSkill::UGA_MutantCutterSkill()
{
}

void UGA_MutantCutterSkill::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
void UGA_MutantCutterSkill::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
