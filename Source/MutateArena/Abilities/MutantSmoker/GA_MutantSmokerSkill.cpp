#include "GA_MutantSmokerSkill.h"
#include "AbilitySystemComponent.h"
#include "MutateArena/Characters/Mutants/MutantSmoker.h"

UGA_MutantSmokerSkill::UGA_MutantSmokerSkill()
{
}

void UGA_MutantSmokerSkill::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
void UGA_MutantSmokerSkill::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
