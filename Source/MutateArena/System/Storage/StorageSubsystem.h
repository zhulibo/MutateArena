...
UCLASS()
class MUTATEARENA_API UStorageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	...
	// 用于缓存所有 DNA 资产的字典
	UPROPERTY(Transient)
	TMap<EDNA2, UDNAAsset2*> CachedDNAAssets;
	void BuildDNACache();
public:
	UDNAAsset2* GetDNAAssetByType(EDNA2 InDNA) const;
